...
import { filterByDotPaths, isPresentInDotFilter, hideComplexValue, hideField, partialCloneSubpath } from '../filterByDotPaths';
describe('filterByDotPaths', () => {
  ...
  describe('partialCloneSubpath()', () => {
    ...
    it('should partial clone deep values', () => {
      ...
      partialCloneSubpath(obj2, ['a', 'aa', 'aaa', '1']); // should have same Shape
  ...
  describe('hideField()', () => {
    ...
    it('should replace `key.subkey.*` on `key.subkey.b` in custom msg', () => {
      ...
      hideField(o, 'key.subkey.*', "use pathsFilter=['key.subkey.*'] to show this field (key.subkey.*)");
      expect(o).toEqual({
        'key.subkey': {
          a: 1,
