...
describe('SchemaComposer', () => {
  ...
  describe('addAsComposer()', () => {
    it('should add ObjectTypeComposer', () => {
      ...
      sc.addAsComposer(new GraphQLObjectType({
        name: 'Object3',
        fields: () => ({})
      }));
    ...
    it('should return InputTypeComposer', () => {
      ...
      sc.addAsComposer(new GraphQLInputObjectType({
        name: 'Object3',
        fields: () => ({})
      }));
    ...
    it('should return ScalarTypeComposer', () => {
      ...
      sc.addAsComposer(new GraphQLScalarType({
        name: 'Object3',
        serialize: () => ({})
      }));
    ...
    it('should return EnumTypeComposer', () => {
      ...
      sc.addAsComposer(new GraphQLEnumType({
        name: 'Object3',
        values: {}
      }));
    ...
    it('should return InterfaceTypeComposer', () => {
      ...
      sc.addAsComposer(new GraphQLInterfaceType({
        name: 'Object3',
        fields: () => ({})
      }));
    ...
    it('should return UnionTypeComposer', () => {
      ...
      sc.addAsComposer(new GraphQLUnionType({
        name: 'Object3',
        types: [a.getType()]
      }));
