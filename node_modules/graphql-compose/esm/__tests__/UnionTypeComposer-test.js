...
import { GraphQLList, GraphQLNonNull, GraphQLInt, GraphQLObjectType, GraphQLUnionType, graphql } from '../graphql';
...
describe('UnionTypeComposer', () => {
  ...
  describe('typeResolvers methods', () => {
    ...
    _asyncToGenerator(function* () {
      ...
      const res = yield graphql(schemaComposer.buildSchema(), `
          query {
            test {
              __typename
              ... on Person {
