...
describe('Resolver', () => {
  ...
  describe('debug methods', () => {
    ...
    describe('debugExecTime()', () => {
      ...
      _asyncToGenerator(function* () {
        ...
        yield r1.debugExecTime().resolve(undefined);
    ...
    describe('debugPayload()', () => {
      ...
      _asyncToGenerator(function* () {
        ...
        yield r1.debugPayload().resolve(undefined);
      ...
      _asyncToGenerator(function* () {
        ...
        yield r1.debugPayload(['b', 'c.3']).resolve(undefined);
        expect(console.log.mock.calls[0]).toEqual(['Resolved Payload for User.find():']);
        expect(console.dir.mock.calls[0]).toEqual([{
          b: 345,
          'c.3': 3
      ...
      _asyncToGenerator(function* () {
        ...
        yield r1.debugPayload().resolve(undefined).catch(e => {});
  ...
  describe('withMiddlewares()', () => {
    ...
    _asyncToGenerator(function* () {
      ...
      /*#__PURE__*/
      function () {
        var _ref9 = _asyncToGenerator(function* (resolve, source, args, context, info) {
          log.push('m1.before');
        ...
        return function mw1(_x4, _x5, _x6, _x7, _x8) {
      ...
      /*#__PURE__*/
      function () {
        var _ref10 = _asyncToGenerator(function* (resolve, source, args, context, info) {
          log.push('m2.before');
          const res = yield resolve(source, args, context, info);
          log.push('m2.after');
          return res;
        ...
        return function mw2(_x9, _x10, _x11, _x12, _x13) {
          return _ref10.apply(this, arguments);
        };
      }();

      const res = yield r.withMiddlewares([mw1, mw2]).resolve({});
