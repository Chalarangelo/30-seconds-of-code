...
export const compileSnippet = async (
  ...
  await Promise.all([
    TextParser.fromPath(path.join(snippetsPath, snippet)),
  ...
  snippetData.ranking = rankSnippet({
    ...
    biasPenaltyMultiplier: biasPenaltyMultiplier ? biasPenaltyMultiplier : 1.0,
  });
  ...
  await writeChunks(
    ...
    [
      ...
      createIndexChunk(
        snippetData.slug,
        'SnippetPage',
        (snippetData.ranking * 0.85).toFixed(2),
        {
          vscodeUrl: `vscode://file/${path.resolve(
