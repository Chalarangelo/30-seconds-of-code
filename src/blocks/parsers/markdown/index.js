...
const blogTransformers = [
  ...
  // Convert blog blockquotes to the appropriate elements
  {
    ...
    replacer: '<blockquote class="blog-quote fs-md md:fs-lg">$1</blockquote>',
  },
  // Convert blog titles h3 and below to the appropriate elements
  {
    ...
    replacer:
      '<h3 class="blog-body-title txt-150 fs-lg md:fs-xl f-alt">$2</h3>',
  },
  // Convert blog titles h4 and above to the appropriate elements
  {
    ...
    replacer:
      '<h4 class="blog-body-title txt-150 fs-md md:fs-lg f-alt">$2</h4>',
  },
