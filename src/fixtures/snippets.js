export const previewSnippet = {
  ...
  searchTokens:
    'ripplebutton jsx react visual state effect render button anim rippl click',
};
...
export const previewBlogSnippet = {
  ...
  icon: 'blog',
  description:
    '<p>Learn how CSS custom properties (CSS variables) work and what you can use them for in your code and designs.</p>',
  url: '/blog/s/css-variables',
  searchTokens:
    'css visual layout learn custom properti variabl work can us code design',
};
...
export const fullSnippet = {
  ...
  url:
    'https://github.com/30-seconds/30-seconds-of-code/blob/master/snippets/mapString.md',
  ...
  tags: {
    primary: 'String',
    all: ['String', 'Array', 'Function', 'Utility', 'Beginner'],
  },
  html: {
  ...
  searchTokens:
    'mapstring js javascript string array function utility creat new result call provid everi charact',
};
...
export const fullReactSnippet = {
  ...
  url:
    'https://github.com/30-seconds/30-seconds-of-react/blob/master/snippets/TagInput.md',
...
export const fullCssSnippet = {
  ...
  url:
    'https://github.com/30-seconds/30-seconds-of-css/blob/master/snippets/bouncing-loader.md',
  ...
  tags: {
    primary: 'Animation',
    all: ['Animation', 'Intermediate'],
  },
  html: {
    html: `<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">="</span>bouncing-loader<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>`,
    css: `<span class="token atrule"><span class="token rule">@keyframes</span> bouncing-loader</span> <span class="token punctuation">{</span>
...
export const fullCssWithJsSnippet = {
  ...
  url:
    'https://github.com/30-seconds/30-seconds-of-css/blob/master/snippets/mouse-cursor-gradient-tracking.md',
  ...
  searchTokens:
    'mouse cursor gradient tracking css visual interactivity hover effect gradient follow mous cursor',
};
...
export const fullBlogSnippet = {
  ...
  url:
    'https://github.com/30-seconds/30-seconds-blog/blob/master/blog_posts/javascript-for-in-for-of-foreach.md',
  ...
  cover: '/static/assets/blog_images/javascript-for-in-for-of-foreach.jpg',
  language: {
    short: '',
    long: '',
  },
  searchTokens:
    "javascript array object iterator learn differ three commonli us iter method offer often confus beginn veteran alik javascript' foreach",
};
...
export const rawBlogSnippet = {
  ...
  cover: 'assets/blog_images/10-vs-code-extensions-for-js-developers.jpg',
  authors: [
    {
      name: 'Angelos Chalaris',
      profile: 'https://twitter.com/chalarangelo',
