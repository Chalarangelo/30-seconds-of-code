    ...
    data: [
      {
        ...
        meta: {
          hash:
            'ba8e5f17500d1e5428f4ca7fcc8095934a7ad3aa496b35465e8f7799f1715aaa',
      ...
      },
      {
        ...
        meta: {
          hash:
            'bda519858588ad61c9200acbb4ea5ce66630eb2ed7ceda96d12518b772b986b9',
    ...
    data: [
      {
        ...
        type: 'snippet',
        tags: {
          all: ['array', 'list', 'lambda', 'intermediate'],
          primary: 'array',
        },
        code: {
          code:
        ...
        meta: {
          hash:
            '3feb7197cde8bf4e7313dd12f4f0ea756c266a9457c6e4913c4ca0e33714b3f1',
      ...
      },
      {
        ...
        meta: {
          hash:
            'e10aa700d64a2b7b526a66ac2e024e1999ef8aef0409760968a8a20080f212c6',
