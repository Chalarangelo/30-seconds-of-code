  ...
  },
  {
    data: [
      ...
      },
      {
        ...
        'type': 'snippet',
        'attributes': {
          'fileName': 'FindLastBy.md',
          'text': 'Returns the last element in a collection that matches the given predicate function, `match`.\n\nUse `IEnumerable.Where()` to filter out all values in `data` for which `match` returns `false`.\nUse `IEnumerable.Last()` to return only the last matching element.\n\n',
          'codeBlocks': {
